...
const AudioPlayerLarge: React.SFC<Props> = props => {
  ...
  return <div className="fixed bottom-0 left-0 flex items-center justify-center w-full h-24 pl-48 border">
    ...
    <div className="flex-auto flex flex-col justify-center ml-8 mr-4 text-center">
      <div className="-mb-1">
        <div className="text-ms font-semibold text-gray-800 leading-tight tracking-wide truncate">{episode}</div>
        <div className="text-sm font-semibold text-gray-700 leading-loose tracking-tigh truncate">{podcast}</div>
      </div>
