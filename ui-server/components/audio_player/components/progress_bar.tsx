...
export default class ProgressBar extends Component<Props, State> {
  ...
  handleSeekBegin = (e: TouchOrMouseEvent) => {
    this.setState({seeking: true, sliderPosition: this.getNewSliderPosition(e)})
  }
  ...
  handleSeekComplete = (_: TouchOrMouseEvent) => {
    ...
    this.props.handleSeek((sliderPosition / this.getSeekBarPosition().width) * duration)
  }
  ...
  render() {
    ...
    return <>
      <div className="relative flex items-center h-4 cursor-pointer select-none"
