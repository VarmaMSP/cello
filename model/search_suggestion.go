...
const (
	SEARCH_SUGGESTION_TYPE_TEXT    = "2"
	SEARCH_SUGGESTION_TYPE_PODCAST = "1"

	SEARCH_SUGGESTION_ICON_SEARCH  = "1"
	SEARCH_SUGGESTION_ICON_HISTORY = "2"
	SEARCH_SUGGESTION_ICON_IMAGE   = "3"
)
